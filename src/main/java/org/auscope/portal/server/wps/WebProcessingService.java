...
import org.n52.wps.commons.*;
import org.n52.wps.io.*;
import org.n52.wps.server.*;
import org.n52.wps.server.database.*;
import org.n52.wps.server.handler.*;
import org.n52.wps.util.*;
import org.slf4j.*;
...
public class WebProcessingService extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            RequestHandler handler = new AuthenticatedRequestHandler(new ByteArrayInputStream(documentString.getBytes("UTF-8")),
                                                        res.getOutputStream(), activeUser);
            String mimeType = handler.getResponseMimeType();
            res.setContentType(mimeType);
